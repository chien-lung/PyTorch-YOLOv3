...
if __name__ == "__main__":
    ...
    parser.add_argument("--augment", default=True, help="allow for data augmentation")
    ...
    # Get dataloader
    dataset = GTSDB_Dataset(train_path, augment=opt.augment, multiscale=opt.multiscale_training)
